            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" asChild>
                  <a href="/projects" onClick={() => posthog.capture('cta_clicked', { cta_name: 'View My Work', destination: '/projects' })}>
                    🚀 View My Work
                  </a>
                </Button>
                <Button variant="outline" size="lg" asChild>
                  <a href="/skills" onClick={() => posthog.capture('cta_clicked', { cta_name: 'Skills & Learning', destination: '/skills' })}>
                    🎯 Skills & Learning
                  </a>
                </Button>
              </div>
              ...
              <div className="pt-6">
                <div className="flex gap-4">
                  <a 
                    ...
                    onClick={() => posthog.capture('social_link_clicked', { social_network: 'GitHub', url: 'https://github.com/MANIKANDAN1709' })}
                  >
                  ...
                  <a 
                    href="https://x.com/MANIKANDAN1709" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="p-3 rounded-full hover:bg-accent transition-colors"
                  ...
                  <a 
                    href="https://instagram.com/manikandan_1709" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="p-3 rounded-full hover:bg-accent transition-colors"
                  ...
                  <a 
                    href="https://youtube.com/@MANIKANDAN1709" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="p-3 rounded-full hover:bg-accent transition-colors"
